Vue.component("right-panel", {
  ...
  <div class="right-panel-wrapper">
    <div class="right-panel clearfix">
      ...
      <div class="survey-wrapper" :class="progressData.isLight ? 'isLight' : 'isFull'"> 
        ...
        <div class="questions-inner" v-for="(qType,qTypeIndex) of rightData" v-if="qType.catType ===1">
              ...
              <div class='validated-error-question' v-html="getError(question.error_id)" v-if="getError(question.error_id)"></div>
                <div class="question-group" >
                  ...
                  <div class="input-box">
                    ...
                    <select class="cst-form-control" @change="handleSelect(qType.catType, quesIndex, null, $event,qTypeIndex)" >
                ...
                <template v-if="question.type=='txt' || question.type=='num' || question.type=='txtNum'">
                ...
                <div class="question-group cus-ddd cus-ddd-wrapper"  :index-attr="quesIndex">
                 ...
                 <div class="multiselect-row multi-row-1">
                    ...
                    <div class="input-box">
                      <select id="cars" :default-placeholder2="question.placeholder2" :default-placeholder3="question.placeholder3" :dependent-one="'cars2_'+quesIndex" :dependent-two="'cars3_'+quesIndex" class="cst-form-control" @change="handleSelect(qType.catType, quesIndex, null, $event,qTypeIndex)" >
                        <option  disabled  v-html="question.placeholder" :selected="question.selectedId==''" ></option>
              ...
              <div class="question-line" v-html='question.questionHeading'></div>
                <div class="question-group" v-for="(option,optionIndex) of question.options">
                  ...
                  <div class="input-box" data-info="option.type">
                    ...
                    <select v-if="option.type=='dd' " class="cst-form-control" @change="handleSelect(qType.catType, quesIndex,optionIndex,$event,qTypeIndex)" >
  ...
  $(".level_2_dd label").click(function(event){
    ...
    if(vueThis.progressData.isLight){
      ...
      // console.log($(".question-row:not(.numboxes)"))

      $(".question-row:not(.numboxes)").each(function(index,element){ 
        //console.log(element);
        //console.log(vueThis.rightData[0].questions[index].grayBG)
        if(index%2==0){        
  ...
  methods: {
    ...
    handleSelect: function (catType, quesIndex, optionIndex, e,questionIndex) {
      console.log(questionIndex)
      //dropdown
      if (catType == 1) {
        this.rightData.forEach((category,index) => {
          if (category.catType == 1 && index==questionIndex) {
            // console.log(category.questions[quesIndex].selectedId)
